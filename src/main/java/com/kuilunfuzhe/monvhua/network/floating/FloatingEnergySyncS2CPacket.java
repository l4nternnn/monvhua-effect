...
public record FloatingEnergySyncS2CPacket(double currentEnergy, double maxEnergy, boolean hasFloatingTag, boolean floatingActive) implements CustomPayload {
    ...
    private void write(RegistryByteBuf buf) {
        ...
        buf.writeBoolean(floatingActive);
    }
