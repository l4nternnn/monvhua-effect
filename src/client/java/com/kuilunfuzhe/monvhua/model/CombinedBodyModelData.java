...
public class CombinedBodyModelData {
    ...
    private static TexturedModelData getTexturedModelData(boolean slim) {
        ...
        if (slim) {
            addArm(root, EntityModelPartNames.RIGHT_ARM, RIGHT_FOREARM, "right_sleeve", RIGHT_FOREARM_SLEEVE,
                    -5.0F, 2.5F, -2.0F, 3.0F, 40, 16, 40, 32);
            addArm(root, EntityModelPartNames.LEFT_ARM, LEFT_FOREARM, "left_sleeve", LEFT_FOREARM_SLEEVE,
        ...
        addLeg(root, EntityModelPartNames.RIGHT_LEG, RIGHT_LOWER_LEG, "right_pants", RIGHT_LOWER_PANTS,
                -1.9F, 0, 16, 0, 32);
        addLeg(root, EntityModelPartNames.LEFT_LEG, LEFT_LOWER_LEG, "left_pants", LEFT_LOWER_PANTS,
                1.9F, 16, 48, 0, 48);
    ...
    private static void addArm(ModelPartData root, String armName, String forearmName,
    ...
    private static void addLeg(ModelPartData root, String legName, String lowerLegName,
